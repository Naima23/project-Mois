...
demarage.addEventListener("click", () => {
    ...
    afficheNum.innerHTML = valeur + "/" + questions.length;
    recuperation();
    progressBar(conter)
...
//****questions****//
const questions = [
    '<p class="form__question--age">Quel est votre âge ? Ceci, afin de calculer un facteur de risque spécifique.</p><div  class="answer-inputs""> <input type="number" id="reponce1" placeholder="15 - 120" min="15" max="120"><span class="input-span">Age</span></div><br><br></br>',
    ...
    // '<p class="form__question--age">Quel est votre âge ? Ceci, afin de calculer un facteur de risque spécifique.</p><div  class="answer-inputs""> <input type="number" id="reponce1" placeholder="15 - 120" min="10" max="120"><span class="input-span">Age</span></div><br><br></br>',
    ...
    ' <p class="form__question">Prenez-vous un traitement immunosuppresseur ? C’est un traitement qui diminue vos défenses contre les infections. Voici quelques exemples : corticoïdes, méthotrexate, ciclosporine, tacrolimus, azathioprine, cyclophosphamide (liste non exhaustive).</p><div class="answer-inputs"><div><input type="radio" name="Q1" id="Oui" value ="Oui" class="modif"><label for="Oui"><span>Oui</span> </label></div><div><input type="radio" name="Q1" id="Non" value="Non"  class="modif"><label for="Non" ><span>Non</span> </label></div></div>',
];
...
Algorithme = () => {
    if (
        ...
        (resultat[3] == "Oui" && resultat[3] == "Oui") ||
        (resultat[1] == "Oui" && resultat[5] == "Oui")
